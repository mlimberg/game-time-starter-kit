...
Game.prototype.updateScore = function() {
  ...
  if(scoreLeft === 9) {
    $('#score-left').css('color', 'red');
  }
  if(scoreRight === 9) {
    $('#score-right').css('color', 'red');
  }
}
...
//   let { ctx, canvas, scoreLeft, scoreRight, startOver } = this;
//   if(scoreLeft === 3) {
//     ctx.clearRect(0, 0, canvas.width, canvas.height)
//     ctx.font = "40px sans-serif";
//     ctx.fillText("LEFT PLAYER WINS!", canvas.width/4, 200)
//     scoreLeft = 0;
//     scoreRight = 0;
//   } else if(scoreRight === 3) {
//     ctx.clearRect(0, 0, canvas.width, canvas.height)
//     ctx.font = "40px sans-serif";
//     ctx.fillText("RIGHT PLAYER WINS!", canvas.width/4, 200)
//     scoreLeft = 0;
//     scoreRight = 0;
//     }
// }
